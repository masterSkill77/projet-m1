...
Route::prefix('/evenement')->middleware('auth:sanctum')->group(function () {
...
Route::prefix('/partenaire')->middleware('auth:sanctum')->group(function () {
...
Route::prefix('/offre')->middleware('auth:sanctum')->group(function () {
...
Route::prefix('/information')->middleware('auth:sanctum')->group(function () {
...
Route::prefix('/information-type')->middleware('auth:sanctum')->group(function () {
